...
from app.queries import get_authors, create_author, get_categories, create_category, get_user_by_name, create_user
...
@app.post("/authors")
async def add_book(author: Author, request: Request, user=Depends(require_admin)):
    conn = request.app.state.db
